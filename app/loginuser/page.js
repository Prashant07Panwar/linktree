...
const onsubmit = async (data) => {
  ...
  try {
    ...
    <form action={""} onSubmit={handleSubmit(onsubmit)} className='flex flex-col  justify-center items-center w-full' >
      ...
      <input type='text' {...register("username",{required:{value:true,message:"Username is required"}})} placeholder='Enter Username ' className='rounded-md focus:outline-[#F6F7F5] w-2/3 h-12 my-2 px-2 shadow-md shadow-slate-600   bg-[#F6F7F5]' onChange={(e)=>{setusername(e.target.value)}}/>
