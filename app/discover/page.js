        ...
        <section className="bg-[#7A0016] min-h-screen grid grid-cols-2">
          ...
          <div className="flex flex-col gap-2 items-start justify-center m-[10vw]">
            <div className="flex flex-col justify-center">
              ...
              <div className="my-6">
                <p className="text-[#E9C0E9] text-xl">
              ...
              {/* Search Form */}
              <form onSubmit={handleSubmit(submit)} className="relative right-5">
                <button type="submit">
                  <svg
                    width="20"
                    height="15"
                    className="stroke-slate-400 relative top-[2px] left-[22px]"
                    viewBox="0 0 20 20"
                    fill="none"
                ...
                <input
                  type="text"
                  {...register("search")}
                  className="w-[20vw] px-6 py-3 rounded-md font-semibold"
          ...
          <div className="flex justify-center flex-col mr-[10vw] mt-16">
            <img src="/discover.jpg" alt="Discover" className="" />
          </div>
        </section>
      </div>
  );
