     ...
     {shownav && <nav className='bg-gray-100 logo w-[90vw] z-[2] rounded-full px-5 py-2 fixed top-10 right-[5vw] flex justify-between'>
        <div className='flex gap-20 items-center'>
             ...
             <ul className='flex gap-10'>
                <Link href="/templates" className='hover:bg-slate-300 hover:rounded-md p-2'><li>Templates</li></Link>
                <Link href="/Marketplace" className='hover:bg-slate-300 hover:rounded-md p-2'><li >Marketplace</li></Link>
                <Link href="/discover" className='hover:bg-slate-300 hover:rounded-md p-2'><li>Discover</li></Link>
                <Link href="/Pricing" className='hover:bg-slate-300 hover:rounded-md p-2'><li>Pricing</li></Link>
